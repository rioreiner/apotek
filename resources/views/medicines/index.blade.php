                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('medicines.show', $medicine) }}" class="text-indigo-600 hover:text-indigo-900">Lihat</a>
                                                @if(auth()->user()->isAdmin())
                                                    <a href="{{ route('medicines.edit', $medicine) }}" class="text-yellow-600 hover:text-yellow-900">Edit</a>
